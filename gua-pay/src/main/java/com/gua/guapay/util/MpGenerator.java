...
public class MpGenerator {
    ...
    //数据库连接url
    private static String dbUrl = "jdbc:mysql://localhost:3306/pay?serverTimezone=GMT%2B8&useUnicode=true&characterEncoding=UTF-8";
    ...
    public static void main(String[] args) {
        ...
        strategy.setInclude(new String[]{"pay","business_record","transfer_record"}); // 需要生成的表
        mpg.setStrategy(strategy);

        // 包配置
        PackageConfig pc = new PackageConfig();
        pc.setParent("com.gua.guapay.modules.business");
        pc.setEntity("entity");
        pc.setMapper("mapper");
